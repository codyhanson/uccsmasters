...
is that data confidentiality and integrety cannot be absolutely guaranteed. Some providers offer server side disk encryption,
but this is not sufficient. There exist API's that allow developers to dynamically store information on these clouds,
